...
class Attendance:
    def __init__(self,root):
        ...
        self.var_atten_attendance=StringVar()
         ...
         # First Image
        img=Image.open(r"img\image17.jpg")
        ...
        #second image
        img1=Image.open(r"img\image15.jpg")
        ...
        # background Image
        img3=Image.open(r"img\image8.jpg")
        img3=img3.resize((1550,700),Image.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)
        
        bg_img=Label(self.root,image=self.photoimg3)        
        bg_img.place(x=0,y=200,width=1550,height=650)
        ...
        Left_frame.place(x=10,y=10,width=760,height=540)
        
        img_left=Image.open(r"img\image18.jpg")
        img_left=img_left.resize((750,100),Image.LANCZOS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)
        
        f_lb1=Label(Left_frame,image=self.photoimg_left)
        f_lb1.place(x=5,y=0,width=750,height=100)
        
        left_inside_frame=Frame(Left_frame,bd=2,relief=RIDGE,bg="white")
        left_inside_frame.place(x=0,y=110,width=755,height=380)
        ...
        attendanceID_entry.grid(row=0,column=1,padx=10,pady=5,sticky=W)
          ...
          #Roll
        rollLabel1=Label(left_inside_frame,text="Roll:",font=("times new roman", 13, "bold"),bg="white")
        ...
        # Name
        nameLabel1=Label(left_inside_frame,text="Name:",font=("times new roman", 13, "bold"),bg="white")
        ...
        # Department
        depLabel1=Label(left_inside_frame,text="Department:",font=("times new roman", 13, "bold"),bg="white")
        depLabel1.grid(row=1,column=2)
        
        atten_dep=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_dep,font=("times new roman" ,13 ,"bold"))
        atten_dep.grid(row=1,column=3,pady=8)
        
          # Time
        timeLabel1=Label(left_inside_frame,text="Time:",font=("times new roman", 13, "bold"),bg="white")
        timeLabel1.grid(row=2,column=0)
        
        atten_time=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_time,font=("times new roman" ,13 ,"bold"))
        atten_time.grid(row=2,column=1,pady=8)
        
        # Date
        dateLabel1=Label(left_inside_frame,text="Date:",font=("times new roman", 13, "bold"),bg="white")
        dateLabel1.grid(row=2,column=2)
        ...
        btn_frame.place(x=0,y=300,width=745,height=115)
        ...
        Right_frame.place(x=800,y=10,width=680,height=540)
 
             
        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=670,height=490)
