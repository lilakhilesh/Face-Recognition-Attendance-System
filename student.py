...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"D:\A1\FRAS\img\image17.jpg")
        ...
        img1=Image.open(r"D:\A1\FRAS\img\image16.jpg")
        ...
        img2=Image.open(r"D:\A1\FRAS\img\image15.jpg")
        ...
        # bg img
        img3=Image.open(r"D:\A1\FRAS\img\image8.jpg")
        ...
        img_left=Image.open(r"D:\A1\FRAS\img\image19.jpg")
        ...
        dep_combo["values"]=("Select Department","IT","Computer","Mca","Cse","Mechanical")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","CA","Adca","BE","Thermodynamics","Dca")
        ...
        semester_combo["values"]=("Select Semester","First","Second","Third","Fourth","Fifth")
        ...
        img_right=Image.open(r"D:\A1\FRAS\img\image18.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Akhilesh@2025",database="face_recognizer")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #..................Load predefined data face frontals....................#
